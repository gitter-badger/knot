...
static knot_layer_state_t reset(knot_layer_t *ctx) { return KNOT_STATE_PRODUCE; }
static knot_layer_state_t begin(knot_layer_t *ctx, void *module_param) { return reset(ctx); }
static knot_layer_state_t finish(knot_layer_t *ctx) { return KNOT_STATE_NOOP; }
static knot_layer_state_t in(knot_layer_t *ctx, knot_pkt_t *pkt) { return KNOT_STATE_DONE; }
static knot_layer_state_t out(knot_layer_t *ctx, knot_pkt_t *pkt) { return KNOT_STATE_CONSUME; }
